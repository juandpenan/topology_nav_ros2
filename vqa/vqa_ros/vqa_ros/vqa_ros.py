...
class VQAModel(Node):
    ...
    def __init__(self):
        ...
        #subscribers
        self.scene_data_subscriber = self.create_subscription(Image,"/image",self.scene_callback,1)
    ...
    def load_model(self):
        self.model =  torch.hub.load('ashkamath/mdetr:main', 'mdetr_efficientnetB5_gqa', pretrained=True, return_postprocessor=False)
